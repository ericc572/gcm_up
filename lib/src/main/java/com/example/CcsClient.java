...
public class CcsClient {
    ...
    private String mApiKey = "AIzaSyDLCsHvbkhz1oVi4r-Th4T5aS3Nw1IGDDY";
    ...
    private CcsClient(String projectId, String apiKey, boolean debuggable) {
        this();
        mApiKey = "AIzaSyDLCsHvbkhz1oVi4r-Th4T5aS3Nw1IGDDY";
    ...
    public static void main(String[] args) {
        final String projectId = "741303851796";
        ...
        final String toRegId ="APA91bEwn5dJwNMJ_KB3Hn_MWF1UuRyy7WAUhhS_1sX5XHqMnOc6rai_lk73XVtv1Q-OoFu4zml_M8cvGnJ6dTg5fidoE-Z5W4Kx-ZWzBsLV8X2ireUXdZR67BSS6KTVOtKjf1Eg3iZG";
